                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="table-responsive">
                               <button class="btn btn-info float-end mt-3 mb-3" data-bs-toggle="modal"
                                                            data-bs-target="#add_modal">Add Alteration Type</button>
                                <table class="table table-bordered mt-5 text-center">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="width:10%">#</th>
                                            <th scope="col">Alteration Type</th>
                                        ...
                                        while ($user1 = mysqli_fetch_assoc($user)):
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="EditModalLabel">Edit Alteration Type</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close">
                                                                <svg> ... </svg>
                                                            </button>
                                                        </div>
                                                        <form action="../Controller/alterController.php" method="POST">
                                                            <div class="modal-body">
                                                                <div class="row mb-4">
                                                                    <div class="col">
                                                                        <input type="hidden" name="id" value="<?= $user1['id'] ?>">
                                                                        <label >Alteration Type</label>
                                                                        <input type="text" name="alter_name"
                                                                            class="form-control"
                                                                            value="<?= $user1['alter_name'] ?>">
                                                                    </div>
                                            ...
                                            <div class="modal fade" id="DeleteModal<?= $user1['id'] ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="DeleteLabel">Delete Alteration Type
                                                            </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close">
                                                                <svg> ... </svg>
        ...
        <!--  END CONTENT AREA  -->
         <div class="modal fade" id="add_modal" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditModalLabel">Add Alteration Type</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                            <svg> ... </svg>
                        </button>
