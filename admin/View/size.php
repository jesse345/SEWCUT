                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="table-responsive">
                               <button class="btn btn-info float-end mt-3 mb-3" data-bs-toggle="modal"
                                                            data-bs-target="#add_modal">Add Size</button>
                                        ...
                                        while ($user1 = mysqli_fetch_assoc($user)):
                                            ...
                                            <div class="modal fade" id="EditModal<?= $user1['id'] ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="../Controller/sizeController.php" method="POST">
                                            ...
                                            <div class="modal fade" id="DeleteModal<?= $user1['id'] ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="DeleteLabel">Delete Size
                                                            </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close">
                                                                <svg> ... </svg>
        ...
        <!--  END CONTENT AREA  -->
         <div class="modal fade" id="add_modal" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditModalLabel">Add Size</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                            <svg> ... </svg>
                        </button>
